...
"""
This code was posted on https://scipython.com/blog/converting-a-spectrum-to-a-colour/
by christian on 27 Mar 2016
string in line 26 was changed
"""
...
class ColourSystem:
    ...
    cmf = np.loadtxt('Skripts/supplementary/cie-cmf.txt', usecols=(1,2,3))
